      ...
      {!newGroup && (
        <div>
            ...
            <div className="flex space-x-2 flex-wrap space-y-1">
              {groupMember.size > 0 &&
                Array.from(groupMember).map((item) => {
                  console.log("group member item", item);
                  return (
                    <SelectedMember
                      member={item}
          ...
          <div className="bottom-10 py-10 bg-slate-200 items-center justify-center">
            <div className="bg-green-600 rounded-full justify-center flex items-center w-[13%]  p-4 cursor-pointer" onClick={() => setNewGroup(true)}>
